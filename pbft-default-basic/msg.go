...
//<REQUEST, o, t, c> with digital signature (in client.go), σ
...
//<PREPREPARE, v, n, d> with digital signature (in node.go), σ, m>
...
//<PREPARE, v, n, d, i> with digital signature, σ (in node.go)
...
//<COMMIT, v, n, d, i> with digital signature, σ (in node.go)
